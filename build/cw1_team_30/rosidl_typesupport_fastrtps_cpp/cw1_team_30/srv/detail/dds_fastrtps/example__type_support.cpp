...
#include "cw1_team_30/srv/detail/example__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cw1_team_30
cdr_serialize(
  const cw1_team_30::srv::Example_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cw1_team_30::srv::Example_Request & ros_message)
{
  // Member: example_float
  cdr >> ros_message.example_float;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cw1_team_30::srv::Example_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cw1_team_30::srv::Example_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cw1_team_30::srv::Example_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_cw1_team_30
const rosidl_message_type_support_t *
get_message_type_support_handle<cw1_team_30::srv::Example_Request>()
{
  return &cw1_team_30::srv::typesupport_fastrtps_cpp::_Example_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cw1_team_30, srv, Example_Request)() {
  return &cw1_team_30::srv::typesupport_fastrtps_cpp::_Example_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cw1_team_30
cdr_serialize(
  const cw1_team_30::srv::Example_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cw1_team_30::srv::Example_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cw1_team_30::srv::Example_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cw1_team_30::srv::Example_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cw1_team_30::srv::Example_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cw1_team_30::srv::typesupport_fastrtps_cpp::_Example_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cw1_team_30, srv, Example_Response)() {
  return &cw1_team_30::srv::typesupport_fastrtps_cpp::_Example_Response__handle;
}
...
{
  return &cw1_team_30::srv::typesupport_fastrtps_cpp::_Example__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cw1_team_30, srv, Example)() {
  return &cw1_team_30::srv::typesupport_fastrtps_cpp::_Example__handle;
}
